...
class Led:
  // static r_ := (pwm.Pwm --frequency=120).start (gpio.Pin 4)
  static g_ := (pwm.Pwm --frequency=120).start (gpio.Pin 16)
  static b_ := (pwm.Pwm --frequency=120).start (gpio.Pin 17)
  static brightness_ := .009
